...
describe('CategoryFakeBuilder Unit Tests', () => {
    describe('category_id prop', () => {
        ...
        test('should throw an error when any methods has called', () => {
    ...
    describe('description prop', () => {
        ...
        test('should pass index to description factory', () => {
            ...
            const category = faker.build();
            expect(category.description).toBe('description 0');
    ...
    describe('created_at prop', () => {
        ...
        test('should throw an error when any methods has called', () => {
            expect(() => faker.created_at).toThrow(new Error("Property created_at not have a factory, use 'with' methods."));
        });
